export const BRAND_NAME = "MetricMind";

export const verificationEmailTemplate = (fullName: string, otp: string): string => {
      ...
      <body>
        <div class="container">
          ...
          <div class="header">
            ...
            <p class="hero-subtitle">Complete your ${BRAND_NAME} registration in seconds</p>
          </div>
          ...
          <div class="content">
            ...
            <p class="description">
              Welcome to ${BRAND_NAME}! We're thrilled to have you join our learning community.
          ...
          <div class="footer">
            ...
            <p class="copyright">© ${new Date().getFullYear()} ${BRAND_NAME}. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
...
export const passwordResetEmailTemplate = (fullName: string, otp: string): string => {
  const firstName = fullName.split(" ")[0];
  return `
    <!DOCTYPE html>
    <html lang="en">
      ...
      <body>
        <div class="container">
          ...
          <div class="header">
            ...
            <p class="hero-subtitle">Secure your ${BRAND_NAME} account in just a few steps</p>
          </div>
